...
def create_directories(pkg_path, epi, run, exe_type):
	root_path = pkg_path + "/exp_2/{}/ep{}_run{}/".format(exe_type, epi, run)
...
def encode_index(epi, run):
	return 1000*(epi+1)+100*run
