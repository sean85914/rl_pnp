...
BARCODE_ROOT = osp.join(HOME, "data/barcode/")
BARCODE_CLASSES = [  # always index 0
    'barcode']
...
class barcodeAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(BARCODE_CLASSES, range(len(BARCODE_CLASSES))))
...
class BarcodeDetection(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=[('train')],
                 transform=None, target_transform=barcodeAnnotationTransform(),
